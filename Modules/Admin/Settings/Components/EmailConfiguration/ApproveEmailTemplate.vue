    ...
    <div class="my-3 mx-24">
        <div class="p-fluid formgrid">
            <div class="field">
                ...
                <InputText id="subject" v-model="email.congrats_subject" class="w-96 mr-3 mb-3" />
            </div>
            <div class="field">
                <label for="message"> {{ $t('Message') }} </label>
                <Editor id="message" v-model="email.congrats_message" editorStyle="height: 320px" />
            </div>
        </div>
    ...
    setup() {
        ...
        const saveEmail = async () => {
            ...
            if (errors.value !== '') {
                ...
                toast.add({ severity: "success", summary: "Successful", detail: "Approve Email Template updated successfully", life: 3000, });
            }
        }
